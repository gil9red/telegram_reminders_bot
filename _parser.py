...
PATTERN_TARGET_DATETIME = re.compile(
    ...
    r'"(?P<target>\w+)" в (?P<day>\d{1,2}) (?P<month>\w+)'
    r"(:?.*?(?P<year>\d{4}))?"
    r"(:?.*?(?P<time>\d{2}:\d{2}))?",
    flags=re.IGNORECASE,
)
...
День рождения "xxx" в 10 февраля в 14:55. Повтор каждый день
День рождения "xxx" в 10 февраля 2026 года. Повтор каждый день
День рождения "xxx" в 10 февраля 2026 года в 14:55. Повтор каждый день
